...
# #load檔案 Martin的  Martin_data

# print(roi_out)
video_addr = "C:/Users/USER/Desktop/MOST/model/martin_avi/ades2_30fps.avi"
cap = cv2.VideoCapture(video_addr)
who_name='ades2_30fps'
roi_out = Martin_data.Detect_face(video_addr) #Martin的
# plt.ion()
...
while 1:
    ...
    print(roi_out[4],roi_out[5],roi_out[6],roi_out[7])
    Bh,Gh,Rh = cv2.split(vid[429:516,936:992])#cv2.split:將圖片猜成三個通道  額頭
    print(len(Bh))
    print(len(Gh))
    print(len(Rh))
