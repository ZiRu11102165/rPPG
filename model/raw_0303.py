    ...
    if os.path.splitext(name)[1] == ".csv":
        ...
        for row in data_y:
            if row == who:
                ...
                continue
        for row in range(150,len(data_x),10):   #sliding window *250*1
...
def Model():
    ...
    model.add(Conv1D(filters=20,kernel_size=9,strides=1,input_shape=(150,1),padding="SAME",activation = 'relu'))  # filters空間維度,kernel_size卷積窗口的長度,strides卷積的步長,
